      ...
      <div className={styles.inner_container}>
        ...
        <div className={styles.options_wrappers}>
          ...
          <ul>
            ...
            <li className={styles.option_li}>
              <Link href={"/admin-panel/project-list"}>
                <div className={styles.option_tab}>
                  <div className={styles.option_icon}>
                    {" "}
                    <PiSquaresFourLight />{" "}
                  </div>
                  <div className={styles.option_text}>Projects</div>
                </div>
              </Link>
            </li>
          </ul>
        ...
        <div className={styles.options_wrappers}>
          ...
          <ul>
            ...
            <li className={styles.option_li}>
              <Link href={"/admin-panel/create-room"}>
                <div className={styles.option_tab}>
                  <div className={styles.option_icon}>
                    {" "}
                    <PiSquaresFourLight />{" "}
                  </div>
                  <div className={styles.option_text}>Create Rooms</div>
                </div>
              </Link>
            </li>
          </ul>
